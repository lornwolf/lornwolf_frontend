    ...
    >
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span
              v-if="scope.row.monday < 7.5 || scope.row.monday > 10"
              style="color: red"
            >{{
              scope.row.monday
            }}</span>
            <span
              v-else
              style="color: black"
            >{{ scope.row.monday }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="data.dates.tuesday"
          width="110"
          align="center"
          :render-header="renderheader"
        >
          <template slot-scope="scope">
            <span
              v-if="scope.row.tuesday < 7.5 || scope.row.tuesday > 10"
              style="color: red"
            >{{
              scope.row.tuesday
            }}</span>
            <span
              v-else
              style="color: black"
            >{{ scope.row.tuesday }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="data.dates.wednesday"
          width="110"
          align="center"
          :render-header="renderheader"
        >
          <template slot-scope="scope">
            <span
              v-if="scope.row.wednesday < 7.5 || scope.row.wednesday > 10"
              style="color: red"
            >{{
              scope.row.wednesday
            }}</span>
            <span
              v-else
              style="color: black"
            >{{ scope.row.wednesday }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="data.dates.thurday"
          width="110"
          align="center"
          :render-header="renderheader"
        >
          <template slot-scope="scope">
            <span
              v-if="scope.row.thurday < 7.5 || scope.row.thurday > 10"
              style="color: red"
            >{{
              scope.row.thurday
            }}</span>
            <span
              v-else
              style="color: black"
            >{{ scope.row.thurday }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="data.dates.friday"
          width="110"
          align="center"
          :render-header="renderheader"
        >
          <template slot-scope="scope">
            <span
              v-if="scope.row.friday < 7.5 || scope.row.friday > 10"
              style="color: red"
            >{{
              scope.row.friday
            }}</span>
            <span
              v-else
              style="color: black"
            >{{ scope.row.friday }}</span>
          </template>
        </el-table-column>
        <el-table-column
          :label="data.dates.saturday"
          width="110"
          align="center"
          :render-header="renderheader"
        >
